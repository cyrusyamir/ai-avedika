...
var SurveyActionBarItem = class extends SurveyElementBase {
  ...
  renderInnerButton() {
    ...
    const button = attachKey2click(React.createElement("button", { className, type: "button", disabled: this.item.disabled, onMouseDown: (args) => this.item.doMouseDown(args), onFocus: (args) => this.item.doFocus(args), onClick: (args) => this.item.doAction(args), title, tabIndex, "aria-checked": this.item.ariaChecked, "aria-expanded": this.item.ariaExpanded, "aria-labelledby": this.item.ariaLabelledBy, role: this.item.ariaRole }, buttonContent), this.item, { processEsc: false });
    return button;
  }
};
...
var PopupContainer = class extends SurveyElementBase {
  ...
  renderHeaderPopup(popupModel) {
    return popupModel.showCloseButton ? React.createElement(
      "button",
      { tabIndex: -1, className: "sv-popup__close-button sd-action sd-action--icon", onClick: () => this.model.clickClose() },
      React.createElement(SvgIcon, { className: "sv-popup__close-button-icon", iconName: "icon-close-24x24", size: "auto" })
    ) : null;
  }
...
var PopupModal = class _PopupModal extends SurveyElementBase {
  ...
  renderElement() {
    return React.createElement(React.Fragment, null, this.modalManager.getModals().map((model) => (0, import_react_dom.createPortal)(React.createElement(PopupContainer, { model }), model.container, model.uniqueId.toString())));
  }
  componentDidMount() {
...
var SurveyQuestionBooleanRadio = class extends SurveyQuestionBoolean {
  ...
  renderRadioItem(value, locText) {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("input", { type: "radio", name: this.question.questionName, value, "aria-errormessage": this.question.ariaErrormessage, checked: value === this.question.value, disabled: this.question.isDisabledAttr, readOnly: this.question.isReadOnlyAttr, className: cssClasses.itemRadioControl, onChange: handleOnChange }),
  ...
  renderElement() {
    ...
    return React.createElement(
      "div",
      { className: cssClasses.rootRadio, onKeyDown: this.handleOnKeyDown },
...
var SurveyProgress = class extends SurveyNavigationBase {
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { style: progressStyle, className: this.model.css.progressBar, role: "progressbar", "aria-valuemin": 0, "aria-valuemax": 100, "aria-label": this.progressBarAriaLabel },
...
var SurveyQuestionPanelDynamicRemoveButton = class extends SurveyQuestionPanelDynamicAction {
  ...
  renderElement() {
    ...
    return React.createElement(
      "button",
      { id, className: this.question.getPanelRemoveButtonCss(), onClick: this.handleClick, disabled: !this.isActionEnabled, type: "button" },
...
checkLibraryVersion(`${"2.5.36"}`, "survey-react-ui");
export {
...
survey-react-ui/fesm/survey-react-ui.mjs:
  (*!
   * surveyjs - Survey JavaScript library v2.5.36
