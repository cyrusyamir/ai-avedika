  ...
  return (
    ...
    >
      <LegalBlock title="Introduction">
        <p>
          Welcome to Avedika. These Terms &amp; Conditions govern your use of our website and
          services, including data collection, transcription, annotation and validation work. By
          accessing the site or engaging our services, you agree to these terms.
        </p>
      </LegalBlock>
      <LegalBlock title="Services">
        <p>
      ...
      <LegalBlock title="Client responsibilities">
        <p>
      ...
      <LegalBlock title="Intellectual property">
        <p>
          ...
          otherwise agreed in writing. Avedika retains ownership of its internal tools, processes
          and methodologies.
        </p>
      </LegalBlock>
